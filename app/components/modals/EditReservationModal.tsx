...
export default function EditReservationModal({ 
  ...
  useEffect(() => {
    if (isOpen && reservation) {
      ...
      setFormData({
        ...
        hostel: reservation.hostel_name,
        hostel_id: reservation.hostel,
        type: reservation.type,
        arrival_date: reservation.arrival_date,
        men_quantity: reservation.men_quantity || 0,
        women_quantity: reservation.women_quantity || 0,
      });
    }
  }, [isOpen, reservation]);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await hostelsService.updateReservation(reservation.id, reservationData);
      onReservationUpdated();
      onClose();
      ...
      const errorMessage = err.response?.data?.detail || 
                          ...
                          'Error al actualizar la reserva. Intente nuevamente.';
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Editar Reserva de Albergue" size="lg">
      {loading ? (
